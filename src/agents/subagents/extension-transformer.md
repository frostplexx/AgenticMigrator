...
other MV2->MV3 change (especially manifest.json) using the migration reference, whether or
...
3. **For each file**:
   - Apply the listed changes for that file, PLUS any other required MV2->MV3 changes you
     identify using the migration reference (manifest fields, service-worker constraints,
